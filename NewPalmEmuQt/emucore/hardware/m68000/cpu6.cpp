...
{	WORD src = nextiword();
	if (cctrue(0)) (Shptr->regs).pc_p = (uint16_t *)(oldpcp + (LONG)src);
}}}
...
{	offset_68k spa = (Shptr->regs).a[7];
	...
	(Shptr->regs).pc_p = (uint16_t *)(oldpcp + (LONG)src);
}}}}}
...
{	char *oldpcp = (char *)(Shptr->regs).pc_p;
{	WORD src = nextiword();
	if (cctrue(2)) (Shptr->regs).pc_p = (uint16_t *)(oldpcp + (LONG)src);
}}}
...
{	char *oldpcp = (char *)(Shptr->regs).pc_p;
{	WORD src = nextiword();
	if (cctrue(3)) (Shptr->regs).pc_p = (uint16_t *)(oldpcp + (LONG)src);
}}}
...
{	char *oldpcp = (char *)(Shptr->regs).pc_p;
{	WORD src = nextiword();
	if (cctrue(4)) (Shptr->regs).pc_p = (uint16_t *)(oldpcp + (LONG)src);
}}}
...
{	char *oldpcp = (char *)(Shptr->regs).pc_p;
{	WORD src = nextiword();
	if (cctrue(5)) (Shptr->regs).pc_p = (uint16_t *)(oldpcp + (LONG)src);
}}}
...
{	char *oldpcp = (char *)(Shptr->regs).pc_p;
{	WORD src = nextiword();
	if (cctrue(6)) (Shptr->regs).pc_p = (uint16_t *)(oldpcp + (LONG)src);
}}}
...
{	char *oldpcp = (char *)(Shptr->regs).pc_p;
{	WORD src = nextiword();
	if (cctrue(7)) (Shptr->regs).pc_p = (uint16_t *)(oldpcp + (LONG)src);
}}}
...
{	char *oldpcp = (char *)(Shptr->regs).pc_p;
{	WORD src = nextiword();
	if (cctrue(8)) (Shptr->regs).pc_p = (uint16_t *)(oldpcp + (LONG)src);
}}}
...
{	char *oldpcp = (char *)(Shptr->regs).pc_p;
{	WORD src = nextiword();
	if (cctrue(9)) (Shptr->regs).pc_p = (uint16_t *)(oldpcp + (LONG)src);
}}}
...
{	char *oldpcp = (char *)(Shptr->regs).pc_p;
{	WORD src = nextiword();
	if (cctrue(10)) (Shptr->regs).pc_p = (uint16_t *)(oldpcp + (LONG)src);
}}}
...
{	char *oldpcp = (char *)(Shptr->regs).pc_p;
{	WORD src = nextiword();
	if (cctrue(11)) (Shptr->regs).pc_p = (uint16_t *)(oldpcp + (LONG)src);
}}}
...
{	char *oldpcp = (char *)(Shptr->regs).pc_p;
{	WORD src = nextiword();
	if (cctrue(12)) (Shptr->regs).pc_p = (uint16_t *)(oldpcp + (LONG)src);
}}}
...
{	char *oldpcp = (char *)(Shptr->regs).pc_p;
{	WORD src = nextiword();
	if (cctrue(13)) (Shptr->regs).pc_p = (uint16_t *)(oldpcp + (LONG)src);
}}}
...
{	char *oldpcp = (char *)(Shptr->regs).pc_p;
{	WORD src = nextiword();
	if (cctrue(14)) (Shptr->regs).pc_p = (uint16_t *)(oldpcp + (LONG)src);
}}}
...
{	char *oldpcp = (char *)(Shptr->regs).pc_p;
{	WORD src = nextiword();
	if (cctrue(15)) (Shptr->regs).pc_p = (uint16_t *)(oldpcp + (LONG)src);
}}}
