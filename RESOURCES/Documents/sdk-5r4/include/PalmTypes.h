...
#define _DIRECT_CALL_WITH_UNPOPPED_16BIT_SELECTOR(table, vector, selector)
...
#define _HAL_TABLE		15
	...
	#define _OS_CALL_WITH_SELECTOR(table, vector, selector)			\
		__attribute__ ((__callseq__ (											\
			"moveq #" _PalmTypes_OS_CALL_Str(selector) ",%%d2; "								\
			"trap #" _PalmTypes_OS_CALL_Str(table) "; dc.w " _PalmTypes_OS_CALL_Str(vector))))
	...
	#define _OS_CALL_WITH_UNPOPPED_16BIT_SELECTOR(table, vector, selector) \
		= { 0x3F3C, selector, 0x4E40 + table, vector }
...
#define _OS_CALL_WITH_UNPOPPED_16BIT_SELECTOR(table, vector, selector) \
	__SPIC__("16bit_unpopped_selector", table, vector, selector)
