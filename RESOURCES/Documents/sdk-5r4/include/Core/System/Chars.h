...
//		Fossil
#define	vchrFossilMin				0x1900			//  16 command keys
#define	vchrFossilMax				0x190F

//		Garmin
#define	vchrGarminMin				0x1A00			// 16 command keys
#define	vchrGarminMax				0x1A0F

//		Tapwave
#define	vchrTapWaveMin				0x1B00			// 256 command keys
...
//		Aceeca
#define vchrAceecaMin				0x1D00			// 16 command keys
#define vchrAceecaMax				0x1D0F
...
//		Pitech
#define	vchrPiTechMin				0x2100			// 256 command keys
#define	vchrPiTechMax				0x21FF
