...
#define btTransportBULibName						"BtTransport BU"
#define btFileCTransportBU							'btbu'	// H4 for Bullet

#define btTransportSULibName						"BtTransport SU"
#define btFileCTransportSU							'btsu'	// H4 for Sumo (Gallahad)

#define btTransportVZLibName						"BtTransport VZ"
#define btFileCTransportVZ							'btvz'	// H4 for VZRef

#define btTransportFGLibName						"BtTransport FG"
#define btFileCTransportFG							'btfg'	// H4 for Fargo

#define btTransportSDIOLibName					"BtTransport SDIO"
#define btFileCTransportSDIO						'btsd'	// SDIO+H4+BCSP for Toshiba SDIO
...
#define btTransportEventLast						11
