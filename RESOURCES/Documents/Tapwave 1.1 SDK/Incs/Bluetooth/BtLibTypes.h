 ...
 *
 * History:
 *   09/10/00	Created by David Kammer
 *
 *****************************************************************************/
...
#define btLibTrapMutex												(sysLibTrapCustom+53)
#define btLibTrapOpenBackground									(sysLibTrapCustom+54)
...
#ifndef PUBLIC_STUFF_STRIPPED
#define btLibTrapUnload												(sysLibTrapCustom+60)
#endif // PUBLIC_STUFF_STRIPPED
...
#define BtLibSdpUuidInitialize(uuid, define, defineSize)  (uuid).size = (defineSize); \
