...
char *__PopStackFrame(ThrowContext *context, ExceptionInfo *info)
{
	...
	if (context->target.has_frame_ptr && context->target.is_Thumb) {
		/*	on Thumb the unique FP points above the outgoing arguments	*/
		frame_size -= context->target.argument_size;
	}
