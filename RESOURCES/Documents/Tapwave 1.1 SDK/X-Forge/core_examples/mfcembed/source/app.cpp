...
extern int gSliderValue; // from ChildView.cpp
...
void MyApp::render()
{
  ...
  INT32 tick=((abs(250-(XFcCore::getTick()%500))/10)+gSliderValue)+1;
...
{
  aAppPrefs.mTotalMemoryLimit=1024*1024*8;
  aAppPrefs.mResourceMemoryLimit=1024*1024*8;
  aAppPrefs.mMinimumExtraMemory = 128 * 1024;
}
