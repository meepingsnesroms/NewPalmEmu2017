 ...
 * 
 * $Id: texture.cpp,v 1.7 2003/04/16 09:35:49 jari Exp $
...
void MyApp::render()
{
    ...
    // Uncomment the following line to enable perspective correction.
    //mGL->setState(XFCGLRS_PERSPECTIVECORRECTION, 1);
...
void xfcAppPref(XFcAppPrefs &aAppPrefs)
{
    ...
    aAppPrefs.mUID = 0x101F4F89; // Symbian application unique ID
