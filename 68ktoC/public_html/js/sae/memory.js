...
//ORG ABFLAG_*
var SAEC_Memory_addrbank_flag_UNK = 0;
var SAEC_Memory_addrbank_flag_RAM = 1;
var SAEC_Memory_addrbank_flag_ROM = 2;
var SAEC_Memory_addrbank_flag_ROMIN = 4;
var SAEC_Memory_addrbank_flag_IO = 8;
var SAEC_Memory_addrbank_flag_NONE = 16;
var SAEC_Memory_addrbank_flag_SAFE = 32;
//var SAEC_Memory_addrbank_flag_INDIRECT = 64;
var SAEC_Memory_addrbank_flag_NOALLOC = 128;
//var SAEC_Memory_addrbank_flag_RTG = 256;
var SAEC_Memory_addrbank_flag_THREADSAFE = 512;
//var SAEC_Memory_addrbank_flag_DIRECTMAP = 1024;
var SAEC_Memory_addrbank_flag_ALLOCINDIRECT = 2048;
var SAEC_Memory_addrbank_flag_CHIPRAM = 4096;
var SAEC_Memory_addrbank_flag_CIA = 8192;
var SAEC_Memory_addrbank_flag_PPCIOSPACE = 16384;

var SAEC_Memory_addrbank_READ = 1;
var SAEC_Memory_addrbank_WRITE = 2;


var SAEC_Memory_banktype_FAST32 = 0; //CE_MEMBANK_FAST32
var SAEC_Memory_banktype_CHIP16 = 1; //CE_MEMBANK_CHIP16
var SAEC_Memory_banktype_CHIP32 = 2; //CE_MEMBANK_CHIP32
var SAEC_Memory_banktype_CIA  = 3;   //CE_MEMBANK_CIA
var SAEC_Memory_banktype_FAST16 = 4; //CE_MEMBANK_FAST16
...
var SAEC_Memory_dummyGet_NONEXISTINGDATA = 0;
...
function SAEO_Memory() {
	var ADDRESS_SPACE_24BIT = false; /* limit address-bus to 24bit */
	var MEMORY_BANKS = ADDRESS_SPACE_24BIT ? 256 : 65536;
	var MEMORY_RANGE_MASK = ADDRESS_SPACE_24BIT ? 0x00FFFFFF : 0xFFFFFFFF;
	...
	var ROM_SIZE_512 = 524288;
	var ROM_SIZE_256 = 262144;
	var ROM_SIZE_128 = 131072;

	var chipmem_start_addr = 0x00000000;
	var bogomem_start_addr = 0x00C00000;
	var cardmem_start_addr = 0x00E00000;
	var kickmem_start_addr = 0x00F80000;
	...
	* write access to boot ROM hides boot ROM and enables write protection */
	...
	var EXTENDED_ROM_CD32 = 1;
	var EXTENDED_ROM_CDTV = 2;
	var EXTENDED_ROM_KS = 3;
	var EXTENDED_ROM_ARCADIA = 4;
	...
	var fkickmem_size = ROM_SIZE_512;
	var fkickmem_halfsize = fkickmem_size >> 1; //OWN
	var kickstore = null;
	var a3000_f0 = false;
	...
	function read_kickstart(f, mem,memo, size, dochecksum, noalias) {
		var kickstring = SAEF_String2Array("exec.library");
		var kickstring_length = kickstring.length;
	...
	function patch_residents(kickmemory, size) {
		//var residents = [ "NCR scsi.device", "scsi.device", "carddisk.device", "card.resource" ];
		var residents = [];
	...
	//var UAE_MEMORY_REGION_NAME_LENGTH = 64;
	var UAE_MEMORY_REGIONS_MAX = 64;
	var UAE_MEMORY_REGION_RAM = 1 << 0;
	var UAE_MEMORY_REGION_ALIAS = 1 << 1;
	var UAE_MEMORY_REGION_MIRROR = 1 << 2;

	var MEMORY_MIN_SUBBANK = 1024;
