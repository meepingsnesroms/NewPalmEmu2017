...
var SAEC_LITTLE_ENDIAN = (function() {
...
var SEEK_SET	= 0; /* set file offset to offset */
var SEEK_CUR	= 1; /* set file offset to current plus offset */
var SEEK_END	= 2; /* set file offset to EOF plus offset */
...
var WAIT_ABANDONED = 0x00000080;
var WAIT_OBJECT_0 = 0x00000000;
var WAIT_TIMEOUT = 0x00000102;
...
int uae_start_thread (var TCHAR *name, void *(*f)(void *), void *arg, uae_thread_id *tid) {
	HANDLE hThread;
	int result = 1;
	unsigned foo;
	struct thparms *thp;
