...
function SAEO_CPU() {
	...
	/* 68020 cache */
	var CACR020_C  = 1 << 3; /* Clear Cache */
	var CACR020_CE = 1 << 2; /* Clear Entry in Cache */
	var CACR020_F  = 1 << 1; /* Freeze Cache */
	var CACR020_E  = 1 << 0; /* Enable Cache */
	var CACR020_RMASK = 0x3;
	var CACR020_WMASK = 0xf;

	var CACHELINES020 = 64;
	var CACHELINE020_IM = CACHELINES020 - 1;
	var CACHELINE020_TM = ~((CACHELINES020 << 2) - 1) >>> 0;
	function cache020() {
		this.data = 0;
		this.tag = 0;
		this.valid = false;
	...
	/* 68030 cache */
	var CACR030_WA   = 1 << 13;	/* Write Allocate */
	var CACR030_DBE  = 1 << 12;	/* Data Burst Enable */
	var CACR030_CD   = 1 << 11;	/* Clear Data Cache */
	var CACR030_CED  = 1 << 10;	/* Clear Entry in Data Cache */
	var CACR030_FD   = 1 << 9;	/* Freeze Data Cache */
	var CACR030_ED   = 1 << 8;	/* Enable Data Cache */
	var CACR030_IBE  = 1 << 4;	/* Instruction Burst Enable */
	var CACR030_CI   = 1 << 3;	/* Clear Instruction Cache */
	var CACR030_CEI  = 1 << 2;	/* Clear Entry in Instruction Cache */
	var CACR030_FI   = 1 << 1;	/* Freeze Instruction Cache */
	var CACR030_EI   = 1 << 0;	/* Enable Instruction Cache */
	var CACR030_RMASK = 0x3313;
	var CACR030_WMASK = 0x3f1f;

	var CACHELINES030 = 16;
	var CACHELINE030_IM = CACHELINES030 - 1;
	var CACHELINE030_TM = ~((CACHELINES030 << 4) - 1) >>> 0;
	function cache030() {
	...
	var ID_BFCHG  = 1; /* <ea> {offset:width} */
	var ID_BFCLR  = 2; /* <ea> {offset:width} */
	var ID_BFEXTS = 3; /* <ea> {offset:width},Dn */
	var ID_BFEXTU = 4; /* <ea> {offset:width},Dn */
	var ID_BFFFO  = 5; /* <ea> {offset:width},Dn */
	var ID_BFINS  = 6; /* Dn, <ea> {offset:width} */
	var ID_BFSET  = 7; /* <ea> {offset:width} */
	var ID_BFTST  = 8; /* <ea> {offset:width} */
