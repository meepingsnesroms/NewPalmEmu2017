...
var SAEC_Model_A500 = 1;
var SAEC_Model_A500P = 2;
var SAEC_Model_A600 = 3;
var SAEC_Model_A1000 = 4;
var SAEC_Model_A1200 = 5;
var SAEC_Model_A2000 = 6;
var SAEC_Model_A3000 = 7;
var SAEC_Model_A4000 = 8;
var SAEC_Model_A4000T = 9;
/* future (cd-emulation is not implemented) */
var SAEC_Model_CDTV = 10;
var SAEC_Model_CD32 = 11;
...
var SAEC_Config_CPU_Model_68000 = 68000;
var SAEC_Config_CPU_Model_68010 = 68010;
var SAEC_Config_CPU_Model_68020 = 68020;
var SAEC_Config_CPU_Model_68030 = 68030;
var SAEC_Config_CPU_Model_68040 = 68040; /* future */
var SAEC_Config_CPU_Model_68060 = 68060; /* future */

var SAEC_Config_CPU_Speed_Maximum = -1;
var SAEC_Config_CPU_Speed_Original = 0;

/*---------------------------------*/
/* chipset */

var SAEC_Config_Chipset_Mask_OCS = 0;
var SAEC_Config_Chipset_Mask_ECS_AGNUS = 1;
var SAEC_Config_Chipset_Mask_ECS_DENISE = 2;
var SAEC_Config_Chipset_Mask_AGA = 4;

var SAEC_Config_Chipset_ColLevel_None = 0;
var SAEC_Config_Chipset_ColLevel_Sprite_Sprite = 1;
var SAEC_Config_Chipset_ColLevel_Sprite_Playfield = 2;
var SAEC_Config_Chipset_ColLevel_Full = 3;


var SAEC_Config_Chipset_CR_MAX = 10;
var SAEC_Config_Chipset_CR_PAL = SAEC_Config_Chipset_CR_MAX + 0;
var SAEC_Config_Chipset_CR_NTSC = SAEC_Config_Chipset_CR_MAX + 1;
var SAEC_Config_Chipset_CR_TOTAL = SAEC_Config_Chipset_CR_MAX + 2;
...
var SAEC_Config_Chipset_Compatible_Generic = 1;
var SAEC_Config_Chipset_Compatible_A500 = 2;
var SAEC_Config_Chipset_Compatible_A500P = 3;
var SAEC_Config_Chipset_Compatible_A600 = 4;
var SAEC_Config_Chipset_Compatible_A1000 = 5;
var SAEC_Config_Chipset_Compatible_A1000V = 6;
var SAEC_Config_Chipset_Compatible_A1200 = 7;
var SAEC_Config_Chipset_Compatible_A2000 = 8;
var SAEC_Config_Chipset_Compatible_A3000 = 9;
var SAEC_Config_Chipset_Compatible_A4000 = 10;
var SAEC_Config_Chipset_Compatible_A4000T = 11;
var SAEC_Config_Chipset_Compatible_CDTV = 12;
var SAEC_Config_Chipset_Compatible_CDTVCR = 13;
var SAEC_Config_Chipset_Compatible_CD32 = 14;

var SAEC_Config_Chipset_CIA_TOD_VSync = 0;
var SAEC_Config_Chipset_CIA_TOD_50Hz = 1;
var SAEC_Config_Chipset_CIA_TOD_60Hz = 2;

var SAEC_Config_RTC_Type_None = 0;
var SAEC_Config_RTC_Type_MSM6242B = 1;
var SAEC_Config_RTC_Type_RF5C01A = 2; /* A3000(T)/A4000(T) */
var SAEC_Config_RTC_Type_MSM6242B_A2000 = 3;

var SAEC_Config_Chipset_IDE_A600A1200 = 1;
var SAEC_Config_Chipset_IDE_A4000 = 2;

/*---------------------------------*/
/* memory */

/* DEPRECATED
var SAEC_Config_RAM_Chip_Size_256K = 256 << 10;
var SAEC_Config_RAM_Chip_Size_512K = 512 << 10;
var SAEC_Config_RAM_Chip_Size_1M = 1024 << 10;
var SAEC_Config_RAM_Chip_Size_2M = 2048 << 10;

var SAEC_Config_RAM_Slow_Size_None = 0;
var SAEC_Config_RAM_Slow_Size_256K = 256 << 10;
var SAEC_Config_RAM_Slow_Size_512K = 512 << 10;
var SAEC_Config_RAM_Slow_Size_1M = 1024 << 10;
var SAEC_Config_RAM_Slow_Size_1536K = 1536 << 10;

var SAEC_Config_RAM_Fast_Size_None = 0;
var SAEC_Config_RAM_Fast_Size_512K = 512 << 10;
var SAEC_Config_RAM_Fast_Size_1M = 1024 << 10;
var SAEC_Config_RAM_Fast_Size_2M = 2048 << 10;
var SAEC_Config_RAM_Fast_Size_4M = 4096 << 10;
var SAEC_Config_RAM_Fast_Size_8M = 8192 << 10;*/

var SAEC_Config_Memory_z3Mapping_Auto = 0;
var SAEC_Config_Memory_z3Mapping_SAE = 1;
var SAEC_Config_Memory_z3Mapping_Real = 2;

//var SAEC_Config_Memory_Custom_MAX = 2; //MAX_CUSTOM_MEMORY_ADDRS

/*---------------------------------*/
/* disk */

var SAEC_Config_Floppy_Type_None = 0;
var SAEC_Config_Floppy_Type_35_DD = 1;
var SAEC_Config_Floppy_Type_35_HD = 2;
var SAEC_Config_Floppy_Type_35_DD_ESCOM = 3;
var SAEC_Config_Floppy_Type_35_DD_PC = 4;
var SAEC_Config_Floppy_Type_35_HD_PC = 5;
var SAEC_Config_Floppy_Type_525_SD = 6;

var SAEC_Config_Floppy_Speed_Turbo = 0;
var SAEC_Config_Floppy_Speed_Original = 100;
...
var SAEC_Config_Mount_Controller_Type_MB_IDE = 1;
var SAEC_Config_Mount_Controller_Type_PCMCIA_SRAM = 2;
var SAEC_Config_Mount_Controller_Type_PCMCIA_IDE = 3;

var SAEC_Config_Mount_Controller_Level_ATA_1 = 0;
var SAEC_Config_Mount_Controller_Level_ATA_2 = 1;
var SAEC_Config_Mount_Controller_Level_ATA_2S = 2;

var SAEC_Config_Mount_Controller_Level_SCSI_1 = 0;
var SAEC_Config_Mount_Controller_Level_SCSI_2 = 1;
var SAEC_Config_Mount_Controller_Level_SASI = 2;
var SAEC_Config_Mount_Controller_Level_SASI_ENHANCED = 2;
var SAEC_Config_Mount_Controller_Level_SASI_CHS = 3;

var SAEC_Config_Mount_Bootpri_NOAUTOBOOT = -128;
var SAEC_Config_Mount_Bootpri_NOAUTOMOUNT = -129;
...
var SAEC_Config_Video_API_Canvas = 0;
var SAEC_Config_Video_API_WebGL = 1;

var SAEC_Config_Video_HResolution_LoRes = 0;
var SAEC_Config_Video_HResolution_HiRes = 1;
var SAEC_Config_Video_HResolution_SuperHiRes = 2;

var SAEC_Config_Video_VResolution_NonDouble = 0;
var SAEC_Config_Video_VResolution_Double = 1;

var SAEC_Config_Video_AP_Fullscreen_WINDOW = 0; //GFX_WINDOW
var SAEC_Config_Video_AP_Fullscreen_FULLSCREEN = 1; //GFX_FULLSCREEN
var SAEC_Config_Video_AP_Fullscreen_FULLWINDOW = 2; //GFX_FULLWINDOW
...
/* DEPRECATED
var SAEC_Config_Audio_Mode_Emul = 0;
var SAEC_Config_Audio_Mode_Play = 1;
var SAEC_Config_Audio_Mode_Play_Best = 2;*/

var SAEC_Config_Audio_Mode_Off = 0;
var SAEC_Config_Audio_Mode_Off_Emul = 1;
var SAEC_Config_Audio_Mode_On = 2;
var SAEC_Config_Audio_Mode_On_Best = 3;

var SAEC_Config_Audio_Freq_Auto = 0;
var SAEC_Config_Audio_Freq_11025 = 11025;
var SAEC_Config_Audio_Freq_22050 = 22050;
var SAEC_Config_Audio_Freq_44100 = 44100;
var SAEC_Config_Audio_Freq_48000 = 48000;

var SAEC_Config_Audio_Channels_Mono = 1;
var SAEC_Config_Audio_Channels_Stereo = 2;

var SAEC_Config_Audio_Filter_Off = 0;
var SAEC_Config_Audio_Filter_Emul = 1;
var SAEC_Config_Audio_Filter_On = 2;
var SAEC_Config_Audio_FilterType_A500 = 0;
var SAEC_Config_Audio_FilterType_A1200 = 1;

var SAEC_Config_Audio_Interpol_None = 0;
var SAEC_Config_Audio_Interpol_Anti = 1;
var SAEC_Config_Audio_Interpol_RH = 2;
var SAEC_Config_Audio_Interpol_Crux = 3;

/*---------------------------------*/
/* input */

var SAEC_Config_Ports_Type_None = 0;
var SAEC_Config_Ports_Type_Mouse = 1;
var SAEC_Config_Ports_Type_Joy0 = 2;
var SAEC_Config_Ports_Type_Joy1 = 3;

var SAEC_Config_Ports_Move_None = 0;
var SAEC_Config_Ports_Move_Arrows = 1;
var SAEC_Config_Ports_Move_Numpad = 2;
var SAEC_Config_Ports_Move_WASD = 3;

var SAEC_Config_Ports_Fire_None = 0;

/*---------------------------------*/
/* debug */

var SAEC_Config_Debug_Level_Fatal = 0;
var SAEC_Config_Debug_Level_Error = 1;
var SAEC_Config_Debug_Level_Warn = 2;
var SAEC_Config_Debug_Level_Info = 3;
var SAEC_Config_Debug_Level_Log = 4;
...
function SAEO_Configuration() {
	...
	/*var MAX_DUPLICATE_EXPANSION_BOARDS = 4;
	var MAX_EXPANSION_BOARDS = 4;
	struct romconfig {
	...
	/*var MONITOREMU_NONE = 0;
	var MONITOREMU_AUTO = 1;
	var MONITOREMU_A2024 = 2;
	var MONITOREMU_GRAFFITI = 3;
	var MONITOREMU_HAM_E = 4;
	var MONITOREMU_HAM_E_PLUS = 5;
	var MONITOREMU_VIDEODAC18 = 6;
	var MONITOREMU_AVIDEO12 = 7;
	var MONITOREMU_AVIDEO24 = 8;
	var MONITOREMU_FIRECRACKER24 = 9;
	var MONITOREMU_DCTV = 10;*/

	/*var AUTOSCALE_NONE = 0;
	var AUTOSCALE_STATIC_AUTO = 1;
	var AUTOSCALE_STATIC_NOMINAL = 2;
	var AUTOSCALE_STATIC_MAX = 3;
	var AUTOSCALE_NORMAL = 4;
	var AUTOSCALE_RESIZE = 5;
	var AUTOSCALE_CENTER = 6;
	var AUTOSCALE_MANUAL = 7; // use gfx_xcenter_pos and gfx_ycenter_pos
	var AUTOSCALE_INTEGER = 8;
	var AUTOSCALE_INTEGER_AUTOSCALE = 9;
	var AUTOSCALE_SEPARATOR = 10;
	var AUTOSCALE_OVERSCAN_BLANK = 11;*/

	/*---------------------------------*/
	/* input */

	/*var MAX_INPUT_DEVICES 20 // maximum number native input devices supported (single type)
	var MAX_INPUT_DEVICE_EVENTS 256 // maximum number of native input device"s buttons and axles supported
	var MAX_INPUT_SETTINGS 4 // 4 different customization settings
	var GAMEPORT_INPUT_SETTINGS 3 // last slot is for gameport panel mappings
	var INTERNALEVENT_COUNT 1

	var MAX_INPUT_SUB_EVENT 8
	var MAX_INPUT_SUB_EVENT_ALL 9
	var SPARE_SUB_EVENT 8
	...
	var MAX_JPORTS_CUSTOM 6
	var MAX_JPORTS 4
	var NORMAL_JPORTS 2
	var MAX_JPORTNAME 128
	struct jport_custom {
	...
	var JPORT_AF_NORMAL 1
	var JPORT_AF_TOGGLE 2
	var JPORT_AF_ALWAYS 3
